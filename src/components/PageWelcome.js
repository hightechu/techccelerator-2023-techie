  ...
  return (
    <div className="container-fluid">   
      ...
      <div className="vstack gap-3 col-md-5 mx-auto">
        <a className="btn btn-lg btn-primary welcome-button login" href="/login">Log In</a>
        <a className="btn btn-lg btn-outline-primary welcome-button signup" href="/signup">Sign Up</a>
      </div>
